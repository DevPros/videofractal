 ...
 */
public class GUIServerOLD extends javax.swing.JFrame {
    ...
    private void btn_startActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_startActionPerformed
        ...
        if (s == null) {
            try {
                ...
                Logger.getLogger(GUIServerOLD.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIServerOLD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIServerOLD().setVisible(true);
            }
        });
    }
